...
object KhiproData {
    ...
    val JUKTOBORNO = mapOf(
        ...
        "cndr" to "চন্দ্র", "cndh" to "চন্ধ", "cndhz" to "চন্ধ্য", "cndhr" to "চন্ধ্র", "cnn" to "চন্ন", "cnb" to "চন্ব", "cnm" to "চন্ম", "cnz" to "চন্য", "cns" to "চন্স",
        "cnsh" to "চনশ", "cngkk" to "চঙ্কক", "cngks" to "চঙ্কস", "cngfkk" to "চঙ্কক", "cngfks" to "চঙ্কস",
